...
export const overlaysCustom: TutorialStepElement[] = [
  {
    label: "Begin custom widget creation",
    content: [
      {
        image: "/overlays/integration/step_1.png",
        text: (
          <Text>
            On your overlays dashboard page, click{" "}
            <Emphasize>My Overlays</Emphasize>.
          </Text>
        ),
      },
      {
        image: "/overlays/integration/step_1_bis.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/step_1_ter.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/step_1_quad.png",
        text: (
          <Text>
  ...
  },
  {
    ...
    content: [
      {
        image: "/overlays/integration/step_2.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/step_2_bis.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/step_2_ter.png",
        text: (
          <Text>
  ...
  },
  {
    ...
    content: [
      {
        image: "/overlays/integration/custom_step_3.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/custom_step_3_bis.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/custom_step_3_ter.png",
        text: (
          <Text>
  ...
  },
  {
    ...
    content: [
      {
        image: "/overlays/integration/custom_step_4.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/custom_step_4_bis.png",
        text: <Text></Text>,
      },
      {
        image: "/overlays/integration/custom_step_4_ter.png",
        text: <Text></Text>,
      },
    ],
  },
  {
    ...
    content: [
      {
        image: "/overlays/integration/step_4.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/step_4_bis.png",
        text: <Text>Choose a name for it</Text>,
      },
      {
        image: "/overlays/integration/step_4_ter.png",
        text: (
          <Text>
