...
export const overlaysBase: TutorialStepElement[] = [
  {
  ...
  },
  {
    ...
    content: [
      {
        image: "/overlays/integration/step_3.png",
        text: (
          <Text>
      ...
      {
        image: "/overlays/integration/step_3_bis.png",
        text: <Text></Text>,
      },
      {
        image: "/overlays/integration/step_3_ter.png",
        text: <Text></Text>,
      },
    ],
  },
